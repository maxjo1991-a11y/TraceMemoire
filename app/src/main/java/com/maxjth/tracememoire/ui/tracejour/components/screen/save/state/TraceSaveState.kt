// FILE: app/src/main/java/com/maxjth/tracememoire/ui/tracejour/components/screen/save/TraceSaveState.kt
package com.maxjth.tracememoire.ui.tracejour.components.screen.save.state
...
data class TraceSaveState(
    ...
    // Cycle confirmé lors de la sauvegarde (ex: "MATIN", "JOUR", "SOIR", "NUIT")
    ...
    fun savedLabelFr(currentCycleKey: String): String? {
        ...
        val savedCycle = lastSavedCycleKey ?: return null
        if (savedCycle != currentCycleKey) return null
